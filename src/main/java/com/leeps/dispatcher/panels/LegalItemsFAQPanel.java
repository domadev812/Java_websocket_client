...
public class LegalItemsFAQPanel extends JPanel {
    ...
    public LegalItemsFAQPanel(AppWideCallsService pAppWideCallsService,
        ...
        JLabel title = new JLabel(AppWideStrings.legalItemsTitleFAQString);
        ...
        centerDetailTextArea.setText(customizedUiWidgetsFactory.readTextFileIntoString(AppWideStrings.legalItemsFAQTextFilename));
