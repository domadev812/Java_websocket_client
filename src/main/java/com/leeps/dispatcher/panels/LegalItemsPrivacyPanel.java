...
public class LegalItemsPrivacyPanel extends JPanel {
    ...
    public LegalItemsPrivacyPanel(AppWideCallsService pAppWideCallsService,
        ...
        JLabel title = new JLabel(AppWideStrings.legalItemsTitlePrivacyString);
