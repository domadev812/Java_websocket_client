...
public class LegalItemsDisclaimerPanel extends JPanel {
    ...
    public LegalItemsDisclaimerPanel(AppWideCallsService pAppWideCallsService,
        ...
        JLabel title = new JLabel(AppWideStrings.legalItemsTitleDisclaimerString);
        ...
        centerDetailTextArea.setText(customizedUiWidgetsFactory.readTextFileIntoString(AppWideStrings.legalItemsDisclaimerTextFilename));
