...
public class MaterialComboBox<T> extends JComboBox<T> {
    ...
    private Color backgroundColor = MaterialColor.WHITE;
    private String hint = "";
...
//        setBackground(MaterialColor.TRANSPARENT);
    ...
    public void paint(Graphics g) {
        ...
        g.setFont(Roboto.MEDIUM.deriveFont(14f));
        ...
        g.drawString(text, 20, metrics.getAscent() + (getHeight() - metrics.getHeight()) / 2);

//        g2.setColor(Utils.applyAlphaMask(getForeground(), LINE_OPACITY_MASK));
//        g2.fillRect(0, getHeight() - 9, getWidth(), 1);

        g2.setColor(new Color(0x4f, 0x4f, 0x4f));
        g2.setStroke(new BasicStroke(2));
        g2.drawPolyline(new int[]{getWidth() - 15, getWidth() - 20, getWidth() - 25}, new int[]{getHeight()/2 - 3, getHeight()/2 + 3, getHeight()/2 - 3}, 3);

//        g2.setColor(Color.GREEN);
//        g2.fillRect((int) ((getWidth() - line.getWidth()) / 2), getHeight(), (int) line.getWidth(), 2);
    }
